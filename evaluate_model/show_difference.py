...
# 配置路径与列名
DATASET1_PATH = "/home/bdhapp/ft/my_work/evaluate_model/score_data/test1"
DATASET2_PATH = "/home/bdhapp/ft/my_work/evaluate_model/score_data/test2"   # 例如 "./my_dataset"
# COLUMN_1 = "conversation"   # 替换为你实际的数据列名
COLUMN_1 = "full_conversation"
...
def navigate_data(current_index, direction):
    ...
    # 获取并格式化数据
    col1 = format_json(dataset1[new_index][COLUMN_1])
    col2 = format_json(dataset2[new_index][COLUMN_1])
